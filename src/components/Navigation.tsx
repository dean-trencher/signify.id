      ...
      <div className="relative">
        ...
        <div className="relative flex items-center justify-between gap-3 px-4 py-2 rounded-full border border-border/40 bg-background/80 backdrop-blur-2xl shadow-xl">
          ...
          <div className="flex items-center gap-2 px-2">
            <img src={signifyLogo} alt="Signify.ai" className="w-[55px] h-[55px] object-contain" />
          ...
          <div className="flex items-center gap-2">
            <a href="#features" className="p-2.5 text-muted-foreground hover:text-foreground transition-all duration-300 rounded-full hover:bg-accent/50 group" aria-label="Features">
              <Star className="w-5 h-5 group-hover:scale-110 transition-transform" />
            </a>
            <a href="#scenarios" className="p-2.5 text-muted-foreground hover:text-foreground transition-all duration-300 rounded-full hover:bg-accent/50 group" aria-label="Use Cases">
              <Info className="w-5 h-5 group-hover:scale-110 transition-transform" />
            </a>
            <a href="#security" className="p-2.5 text-muted-foreground hover:text-foreground transition-all duration-300 rounded-full hover:bg-accent/50 group" aria-label="Security">
